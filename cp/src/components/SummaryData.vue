    ...
    >
      ...
      <template slot="title">
        <a-form layout="inline">
          <a-form-item :label="baseInfo.name">
            <a-input
              placeholder="请输入刷新数据数量"
              v-model="flashNum"
            ></a-input>
          </a-form-item>
          <a-form-item :wrapper-col="{ wrapperCol: { span: 14, offset: 4 } }">
            <a-button type="primary" @click="submitFlash"> 刷新 </a-button>
          </a-form-item>
        </a-form>
